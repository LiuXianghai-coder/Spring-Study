...
public class RedissionDelayQueueMockTest {

    private final static Logger log = LoggerFactory.getLogger(RedissionDelayQueueMockTest.class);

    @Test
    public void delayQueueMockTest() throws Throwable {
